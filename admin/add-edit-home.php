...
if (isset($_POST['edit'])) {
  ...
  $qUpdate = mysqli_query($conn, "UPDATE home SET $fillQupdate nama='$nama', job='$job' WHERE id = $id");
  if ($qUpdate){
    header("Location: home.php");
  }
}
            ...
            <div class="card-body">
              ...
              <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="nama" placeholder="Masukkan Nama JOb Desc" required value="<?php echo isset($_GET['Edit']) ? $rowUpdate['job'] : '' ?>">
                  </div>
                </div>
